...
an Claude Code. Er beachtet Node-Stream-Backpressure und bricht den
Upstream-Request ab, wenn Claude Code die lokale Verbindung schliesst. Dadurch
sollte eine kurzzeitige \code{connection interrupted}-Meldung nicht den
